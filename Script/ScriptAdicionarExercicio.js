...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("btAdicionarLinha").addEventListener("click", adicionarNovaLinha);

  // (Req 3 - Bônus) Adiciona listener para os botões de lixeira (usando delegação)
  document.getElementById("tabelaExerciciosBody").addEventListener("click", function(e) {
